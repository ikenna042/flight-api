...
function isValidDriver(req, res, next) {
  ...
  console.log("\nValidating userType ".concat(userType, ", id ").concat(id, ", email ").concat(email, " vehicle ").concat(vehicle));
  return next();
}
...
function isValidCustomer(req, res, next) {
  ...
  console.log("\nValidating userType ".concat(userType, ", id ").concat(id, ", email ").concat(email, " phone ").concat(phone));
  return next();
}

function isValidRole() {
  var officeArray = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var roleCode = arguments.length > 1 ? arguments[1] : undefined;
